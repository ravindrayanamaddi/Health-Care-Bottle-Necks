...
def load_data():
    ...
    # ── FACT TABLES ─────────────────────────────
    staffing = pd.read_csv(r"C:\Users\RAVI\Downloads\DA Hsptl\Fact_Staffing.csv")
    deptlogs = pd.read_csv(r"C:\Users\RAVI\Downloads\DA Hsptl\Fact_DeptLogs.csv")
...
def build_sidebar(df):
    ...
    with st.sidebar:
        ...
        <div style='text-align:center;padding:10px 0 20px 0;'>
            ...
            <div style='font-size:15px;font-weight:700;color:#f0f6fc;'>Hospital BI</div>
